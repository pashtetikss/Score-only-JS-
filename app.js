...
plus.onclick = function() {
  ...
  magic.onclick = function() {
    ...
    let rndCol1 = 'rgb(' + random(255) + ',' + random(255) + ',' + random(255) + ')';
    let rndCol2 = 'rgb(' + random(255) + ',' + random(255) + ',' + random(255) + ')';
